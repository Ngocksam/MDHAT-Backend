...
<?php include('includes/sidebar.php');?>
      <section id="main-content">
          <section class="wrapper site-min-height">
          	<h3><i class="fa fa-angle-right"></i> Détails de la réclamation</h3>
            <hr />

 <?php $query=mysqli_query($bd, "select tblcomplaints.*,category.categoryName as catname,nom_complet,genre,statut_matrimonial,contact,email,adresse from tblcomplaints join category on category.id=tblcomplaints.category where userId='".$_SESSION['id']."' and complaintNumber='".$_GET['cid']."'");

while($row=mysqli_fetch_array($query))
{?>
          	<div class="row mt">
            <label class="col-sm-2 col-sm-2 control-label"><b>Numéro de la réclamation : </b></label>
          		<div class="col-sm-4">
...
<?php } ?>
 ...
 <div class="row mt">
            ...
            <div class="row mt">
    <label class="col-sm-2 col-sm-2 control-label"><b>Nom complet :</b></label>
    <div class="col-sm-4">
        <p><?php echo htmlentities($row['nom_complet']);?></p>
    </div>
</div>


<div class="row mt">
    <label class="col-sm-2 col-sm-2 control-label"><b>Genre :</b></label>
    <div class="col-sm-4">
        <p><?php echo htmlentities($row['genre']);?></p>
    </div>
</div>

<div class="row mt">
    <label class="col-sm-2 col-sm-2 control-label"><b>Statut Matrimonial :</b></label>
    <div class="col-sm-4">
        <p><?php echo htmlentities($row['statut_matrimonial']);?></p>
    </div>
</div>
...
<div class="row mt">
    <label class="col-sm-2 col-sm-2 control-label"><b>Adresse :</b></label>
    <div class="col-sm-4">
        <p><?php echo htmlentities($row['adresse']);?></p>
    </div>
</div>
nb
