...
<html lang="en">
     ...
     <?php include("includes/header.php");?>
      ...
      <section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> info Profile</h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <b>Bravo!</b> <?php echo htmlentities($successmsg);?></div>
                      <?php }?>
 ...
 ?>                     
  ...
  <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['fullName']);?>'s Profile</h4>
    <h5><b>Dernière mise à jour à :</b>&nbsp;&nbsp;<?php echo htmlentities($row['updationDate']);?></h5>
...
<label class="col-sm-2 col-sm-2 control-label">Email de l'utilisateur </label>
 <div class="col-sm-4">
...
<div class="form-group">
<label class="col-sm-2 col-sm-2 control-label">Contacte</label>
 <div class="col-sm-4">
...
<label class="col-sm-2 col-sm-2 control-label">Date d'enregistrement </label>
<div class="col-sm-4">
