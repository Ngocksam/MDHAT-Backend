...
{?>
					  			...
					  			<p><?php echo htmlentities($num1);?> Plaintes pas encore traitées</p>
                  		</div>
                      <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Statut des réclamations en cours</p>
                      </div>
  <?php }?>
...
{?>
                  ...
                  <p><?php echo htmlentities($num1);?> Plainte close</p>
                      </div>
