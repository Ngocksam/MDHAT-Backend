		              ...
		              <div class="modal-dialog">
		                  <div class="modal-content">
		                      ...
		                      <div class="modal-body">
		                          <p>Entrez vos coordonnées ci-dessous pour réinitialiser votre mot de passe.</p>
...
<input type="password" class="form-control unicase-form-control text-input" placeholder="Confirm Password" id="confirmpassword" name="confirmpassword" required >
		                      ...
		                      <div class="modal-footer">
		                          ...
		                          <button class="btn btn-theme" type="submit" name="change" onclick="return valid();">Soumettre</button>
		                      </div>
		                  </div>
		              </div>
		          </div>
